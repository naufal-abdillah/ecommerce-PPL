        ...
        <div class="container"><a class="navbar-brand logo" href="#">Brand</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?php echo base_url('Login');?>">Login</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form method ="post" action = <?= base_url('Auth/login');?>>
                    <div class="form-group"><label for="email">Email</label><input name = "name" class="form-control item" type="email" id="email"></div>
                    <div class="form-group"><label for="password">Password</label><input name = "email" class="form-control" type="password" id="password"></div>
