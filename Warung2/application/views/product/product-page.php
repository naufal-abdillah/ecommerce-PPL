                        ...
                        <div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane active fade show description" role="tabpanel" id="description">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <figure class="figure"><img class="img-fluid figure-img" src="<?php echo base_url('assets/img/tech/image3.png');?>"></figure>
                                        </div>
                                        <div class="col-md-7">
                                            <h4>Lorem Ipsum</h4>
                                ...
                                <div class="tab-pane fade show" role="tabpanel" id="reviews">
                                    <div class="reviews">
                                        <div class="review-item">
                                            <div class="rating"><img src="<?php echo base_url('assets/img/star.svg');?>"><img src="<?php echo base_url('assets/img/star.svg');?>"><img src="<?php echo base_url('assets/img/star.svg');?>"><img src="<?php echo base_url('assets/img/star.svg');?>"><img src="<?php echo base_url('assets/img/star-empty.svg');?>"></div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="clean-related-item">
                                        <div class="image"><a href="#"><img class="img-fluid d-block mx-auto" src="<?php echo base_url('assets/img/tech/image2.jpg');?>"></a></div>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="clean-related-item">
                                        <div class="image"><a href="#"><img class="img-fluid d-block mx-auto" src="<?php echo base_url('assets/img/tech/image2.jpg');?>"></a></div>
                                        <div class="related-name"><a href="#">Lorem Ipsum dolor</a>
                                            <div class="rating"><img src="<?php echo base_url('assets/img/star.svg');?>"><img src="<?php echo base_url('assets/img/star.svg');?>"><img src="<?php echo base_url('assets/img/star.svg');?>"><img src="assets/img/star-half-empty.svg"><img src="<?php echo base_url('assets/img/star-empty.svg');?>"></div>
                                            <h4>$300</h4>
                                        </div>
                                    </div>
                                </div>
