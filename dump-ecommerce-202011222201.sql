...
INSERT INTO `barang` VALUES (1,1,'Sepatu Converse All Star','Jaga agar pilihan sneakernya tetap sporty, fleksibel, dan sangat nyaman dengan sepatu SKECHERS Bounder - Zallow. Kain rajutan rajut yang direkayasa secara lembut dan sintetis bagian atas dalam selip pada peregangan bertali sp',300000,'Fashion','sepatu.jpg'),(2,2,'Samsung Galaxy A31','Barang yg kita jual 100% orignal n bergaransi Resmi',4000000,'Elektronik','hp.jpg'),(3,2,'Laptop ASUS X441UV ','Deskripsi : ASUS X441UV INTEL CORE I3-7100 NVIDIA 4GB/1TB/WINDOWS 10',5000000,'Elektronik','laptop.jpg'),(4,2,'Kamera Mirrorless Xiaomi - Xiaoyi YI M1','> 20MP Micro Four Thirds sensor',3000000,'Elektronik','kamera.jpg');
...
CREATE TABLE `order` (
  ...
  PRIMARY KEY (`idOrder`),
  KEY `order_FK` (`idUser`),
  CONSTRAINT `order_FK` FOREIGN KEY (`idUser`) REFERENCES `user` (`idUser`)
...
INSERT INTO `order` VALUES (1,1,'2020-11-22 07:15:56',300000);
...
CREATE TABLE `orderdetails` (
  ...
  KEY `orderDetails_FK_1` (`idBarang`),
  CONSTRAINT `orderDetails_FK` FOREIGN KEY (`idOrder`) REFERENCES `order` (`idOrder`),
  CONSTRAINT `orderDetails_FK_1` FOREIGN KEY (`idBarang`) REFERENCES `barang` (`idBarang`)
...
INSERT INTO `seller` VALUES (1,'Kilback-Casper'),(2,'Roob Inc'),(3,'Roberts Group'),(4,'Berge-Legros'),(5,'Renner, Runolfsson and Frami'),(6,'Cruickshank-Homenick'),(7,'Fay Group'),(8,'Nienow LLC'),(9,'Will-Runte'),(10,'Vandervort, Cronin and Cummerata');
...
-- Dump completed on 2020-11-22 22:01:22
